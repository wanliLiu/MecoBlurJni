...
JNIEXPORT void JNICALL Java_com_milanoo_meco_JniBlur_ImageBlur_blurIntArray(JNIEnv *env, jclass obj, jintArray arrIn, jint w, jint h, jint r)
{
    jint *pix;
...
JNIEXPORT void JNICALL Java_com_milanoo_meco_JniBlur_ImageBlur_blurBitMap(JNIEnv *env, jclass obj, jobject bitmapIn, jint r)
{
